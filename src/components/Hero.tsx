      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="ml-16" 
          >
            <h1 className="text-7xl font-bold mb-4 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-lg">
              Harikarthik A
            </h1>
            <motion.h2 
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="mailto:hariprasanth1328@gmail.com"
              ...
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href="https://linkedin.com/in/harikarthik13/"
                target="_blank"
              ...
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href="https://github.com/harikarthik13"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="flex gap-8">
              ...
              <div>
              <h3 className="text-xl font-semibold text-purple-300">BCA</h3>
              <p className="text-purple-200/70">2023</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-purple-300">MCA</h3>
              <p className="text-purple-200/70">Pursuing-correspondence</p>
            </div>
          </div>
              </motion.div>
            </div>
