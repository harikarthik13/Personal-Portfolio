    ...
    <footer className="bg-gray-900 py-20 border-t border-white/10">
      <div className="container mx-auto px-4">
        ...
        >
          <div>
            ...
            <div className="space-y-4">
              <a href="mailto:hariprasanth1328@gmail.com" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                <Mail className="w-5 h-5" />
                hariprasanth1328@gmail.com
              </a>
              <a href="tel:+916379226326" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Harikarthik A. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
